...
#define DISPLAY_MODE_TEMPS      3
#define DISPLAY_MODE_CHARGE     4
#define DISPLAY_MODE_CONNECT    5
...
void draw_display (Adafruit_SSD1306, uint8_t, VOTOL_Response_t*, BMS_SOC_Report_t*, BMS_Temp_Report_t*, BMS_Fault_Report_t*);
